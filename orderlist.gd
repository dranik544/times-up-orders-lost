...
var orders: Array = [
	...
	# ---------- СТАРЫЙ ЗАКАЗ: Интернет-магазин 'Технорай' (DEFAULT) ----------
	{
		...
		"groups": [
			{
				"desc": "Нижняя граница цены: {min_price} руб. Начинаем с {min_price_alt}? Нет, {min_price}.",
				"frmt": {
			...
			{
				"desc": "Верхняя граница цены: {max_price} руб. Не больше {max_price_alt}? Нет, {max_price}.",
				"frmt": {
