...
var orders: Array = [
	...
	{
		"name": "3.14door games",
		"desc": "[center][b]Привет![/b][/center]\nНадо сделать игру для геймджема, [shake]прям срочно[/shake], а то сроки поджимают! [wave][color=#82ffbe]Выигрыш[color=] поделим на попола<<<<м[/wave].",
		...
		"groups": [
			...
			{
				"desc": "Геймплей пусть будет {gameplay_text}, надеюсь мы успеем его реализовать за пару дней!",
